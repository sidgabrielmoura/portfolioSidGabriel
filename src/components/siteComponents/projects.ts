...
export const bigProjects = [
    ...
    },
    {
        hrefGit: "/",
        linkGitName: "...",
        imageUrl: "bg-[url(../assets/raffles-layout.webp)]",
        projectName: "web raffles",
        linkProjectView: "https://rifas.golsport520.online/",
        linkProjectName: "rifas.golsport520.online",
        tools: "Vue.js / Nuxt.js / Tailwindcss/ Tailwindcss / TypeScript / Pinia / API RestFull",
    },
]